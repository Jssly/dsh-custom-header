/**
 * Typecheck stubs for @deepseek-ai/dsh-typert-protocol — the strict Remote
 * namespace layer used by the host manifest and the client mount.
 */
 ...
 *  Standard (TC39) method decorator: `@Remote`. */
